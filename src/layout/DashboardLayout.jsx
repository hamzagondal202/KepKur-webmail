...
//       <div className={`transition-all duration-400 ${isSidebarOpen ? 'w-64' : 'w-0'} fixed left-0 top-16 z-50 overflow-hidden`}>
...
import Header from "../components/Header";
import Sidebar from "../components/Sidebar";
import { SidebarProvider, useSidebar } from "../../src/contextApi/SideBarContext";
...
const DashboardContent = () => {
  const { isSidebarOpen,toggleSidebar } = useSidebar(); // Get state from context
